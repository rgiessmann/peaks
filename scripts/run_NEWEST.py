...
insilico.NOISE_PEAK_ABSOLUTE_LOC = constants_and_values["NOISE_PEAK_ABSOLUTE_LOC"]
insilico.NOISE_PEAK_ABSOLUTE_SD  = constants_and_values["NOISE_PEAK_ABSOLUTE_SD"]
insilico.NOISE_PEAK_RELATIVE_LOC = constants_and_values["NOISE_PEAK_RELATIVE_LOC"]
...
footprint.tracelist_to_csv([ref], "peakheights-ref.csv")
...
df_out.to_csv("statistics-kdmin.csv")
...
for alpha in [0.05, 0.025, 0.01, 0.005, 0.001]:
    ...
    classification_df.to_csv("classification_alpha{}.csv".format(alpha))
